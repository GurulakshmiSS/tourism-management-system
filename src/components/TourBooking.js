    ...
    <div >
        ...
        <div className="event-management">
          ...
          <form onSubmit={handleSubmit}>
            <div className="row">
                <div className="col-md-12 text-center"><h2>Book Your Tour</h2></div>
            </div>
            <div className="row">
                <div className="col-md-5">Booking ID</div>
            ...
            <br/>
            <div className="row">
                <div className="col-md-5">User's ID</div>
                <div className="col-md-7">
                <input
                    type='number'
                    name="user_id"
            ...
            <br/>
            <div className="row">
                <div className="col-md-5">Tour ID</div>
                <div className="col-md-7">
                <input
                    type="number"
                    name="tour_id"
            ...
            <br/>
            <div className="row">
                <div className="col-md-5">Booking Date</div>
                <div className="col-md-7">       
                <input
                    type="date"
                    name="booking_date"
            ...
            <div className="row">
                <div className="col-md-5">Number of Partcipants</div>
                <div className="col-md-7">       
                <input
                    type="number"
                    name="participants"
            ...
            <div className="row">
                <div className="col-md-5">Total Price</div>
                <div className="col-md-7">       
                <input
                    type="number"
                    name="total_price"
            ...
            <br/>
            <div className="row">
                <div className="col-md-5">Booking Status</div>
                <div className="col-md-7">       
                <input
                    type="text"
                    name="booking_status"
