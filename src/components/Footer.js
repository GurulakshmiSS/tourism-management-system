import footer from './img/logo/logo2_footer.png';
function Footer(){
    return(
<footer>
        {/* <!-- Footer Start--> */}
        <div class="footer-area footer-padding footer-bg"  style={{backgroundImage: 'url(' + require('./img/service/footer_bg.jpg') + ')'}}>
            <div class="container">
