...
import service2 from './img/service/services2.jpg';
import service3 from './img/service/services3.jpg';
import service4 from './img/service/services4.jpg';
import service5 from './img/service/services5.jpg';
import service6 from './img/service/services6.jpg';
import support1 from  './img/service/support-img.jpg';
import testimonial1 from './img/icon/testimonial.png';
import testimonial2 from './img/testmonial/Homepage_testi.png';
      ...
      <main>
        ...
        <div class="slider-area ">
            ...
            <div class="slider-active">
                <div class="single-slider hero-overly  slider-height d-flex align-items-center" style={{backgroundImage: 'url(' + require('./../img/hero/h1_hero.jpg') + ')'}}>
                    <div class="container">
                        <div class="row">
        ...
        {/* <!-- Video Start Arera --> */}
        <div class="video-area video-bg pt-200 pb-200"   style={{backgroundImage: 'url(' + require('./../img/service/video-bg.jpg') + ')'}}>
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
        ...
        {/* <!-- Testimonial Start --> */}
        <div class="testimonial-area testimonial-padding"  style={{backgroundImage: 'url(' + require('./img/testmonial/testimonial_bg.jpg') + ')'}}>
            <div class="container ">
